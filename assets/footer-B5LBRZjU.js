import{a as ee}from"./vendor-B2N6ulqC.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function o(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(i){if(i.ep)return;i.ep=!0;const r=o(i);fetch(i.href,r)}})();const w="163542112cf15bca1d68bf0de03b2c75",te="TMDB live data is unavailable because VITE_TMDB_KEY is missing.",oe=()=>!!w,ke=()=>w,ie=ee.create({baseURL:"https://api.themoviedb.org/3"}),p=async(e,t={})=>{try{if(!oe())throw new Error(te);return(await ie.get(e,{params:{api_key:w,...t}})).data}catch(o){throw console.error("API ERROR:",o.message),o}},se=(e="day")=>p(`/trending/movie/${e}`),Ee=(e=1,t="week")=>p(`/trending/movie/${t}`,{page:e}),Ae=(e,t=1,o="")=>p("/search/movie",{query:e,page:t,primary_release_year:o||void 0}),j=e=>p(`/movie/${e}`),re=e=>p(`/movie/${e}/videos`);let u=null;const ne=async()=>{if(u)return u;const e=await p("/genre/movie/list");return u=new Map(e.genres.map(t=>[t.id,t.name])),u},je=async e=>{const t=await ne();return e.map(o=>t.get(o)||"Unknown")},_="movie-spotlight-overlay",M="cinemania-saved-movies";function ae(e,t){return`
    ...
    <div class="spotlight-shell" role="dialog" aria-modal="true" aria-labelledby="spotlight-title">
      ...
      <div class="spotlight-content">
        ...
        <div class="spotlight-meta">
          ${f("Vote / Votes",ae(e.vote_average,e.vote_count))}
          ${f("Popularity",s)}
          ${f("Genre",o)}
        </div>
  ...
  `}function Le(e){const t=document.getElementById("hero");if(!t||!e)return;const o=t.querySelector(".btn--primary"),s=t.querySelector(".btn--secondary");o==null||o.addEventListener("click",()=>{he(e)}),s==null||s.addEventListener("click",()=>{pe(e)})}var c=document.getElementById("teamModalOverlay"),E=document.getElementById("openTeamModal"),A=document.getElementById("closeTeamModal");c&&E&&A&&(E.addEventListener("click",function(){c.classList.remove("hidden"),document.body.style.overflow="hidden"}),A.addEventListener("click",function(){c.classList.add("hidden"),document.body.style.overflow=""}),c.addEventListener("click",function(e){e.target===c&&(c.classList.add("hidden"),document.body.style.overflow="")}),document.addEventListener("keydown",function(e){e.key==="Escape"&&!c.classList.contains("hidden")&&(c.classList.add("hidden"),document.body.style.overflow="")}));export{te as T,me as a,ke as b,je as c,se as d,Se as e,Ee as f,ne as g,oe as h,Me as i,Ae as j,pe as s};
//# sourceMappingURL=footer-B5LBRZjU.js.map
