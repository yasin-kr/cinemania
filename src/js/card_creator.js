...
export function createMovieCard(movie, genreNames) {
  ...
  const starsHtml =
    '<div class="movie-card__stars">' +
    generateStarIconsMarkup(movie.vote_average, 'movie-card__star') +
    '</div>';
  ...
  li.innerHTML =
    ...
    '" alt="' +
    movie.title +
    '" loading="lazy" decoding="async" width="395" height="574" onerror="this.src=\'' +
    FALLBACK +
    '\'">' +
